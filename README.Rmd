...
```
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-yellowgreen.svg)](/commits/master) [![minimal R version](https://img.shields.io/badge/R%3E%3D-3.2.4-6666ff.svg)](https://cran.r-project.org/) 
...
```{r, out.width = 50, fig.retina = NULL, echo = FALSE}
knitr::include_graphics("https://mfr.osf.io/export?url=https://osf.io/hr67w/?action=download%26direct%26mode=render&initialWidth=733&childId=mfrIframe&format=1200x1200.jpeg")
knitr::include_graphics("https://mfr.osf.io/export?url=https://osf.io/u63nr/?action=download%26direct%26mode=render&initialWidth=733&childId=mfrIframe&format=1200x1200.jpeg")
```
