...
ggplot(moved,
 ...
 coord_fixed(ratio = 1) +
  xlim(xmin, xmax) +
  ylim(ymin, ymax) +
  ggtitle(paste0("Plan view of all artefact \nlocations 
                 during ", n, " simulated events \nfor all artefacts")) +
