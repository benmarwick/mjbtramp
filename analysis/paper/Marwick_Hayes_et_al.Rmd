...
A common limitation of experimental studies of taphonomic processes such as trampling is the short time scale of experimental observations relative to the time scales in archaeological sites. The duration of our experiement was particularly short due to the unique use of the archaeological sediments in the spoil heap as the trampling substration. To explore what might have happened if our experiment had run for a long time we can simulate the effects of trampling by resampling many times from the observed trampling event measurements.  
