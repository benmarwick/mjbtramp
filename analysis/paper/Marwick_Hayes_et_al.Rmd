...
# statistical tests for changes in orientations
# first check for von mises distribution or not ('normal'), then test

# The Rayleigh test and Watson’s U test are used to test for randomness and normality, respectively.  For directional data with von Mises distributions, we use Watson–Williams tests, and for non-von Mises distributed data, we use Mardia–Watson–Wheeler tests 
...
```{r}
# statistical tests for differences in orientation and plunge
